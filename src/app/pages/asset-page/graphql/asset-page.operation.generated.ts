...
export type AssetPageGetIPsQueryVariables = SchemaTypes.Exact<{
  [key: string]: never;
}>;
...
export type AssetPageGetNetworkServicesQueryVariables = SchemaTypes.Exact<{
  [key: string]: never;
}>;
...
export type AssetPageGetDomainNamesQueryVariables = SchemaTypes.Exact<{
  [key: string]: never;
}>;
...
export class AssetPageGetIPsQueryService extends Apollo.Query<
  AssetPageGetIPsQuery,
  AssetPageGetIPsQueryVariables
> {
