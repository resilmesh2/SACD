...
export type CsaPageGetNodeObjectsQueryVariables = SchemaTypes.Exact<{
  [key: string]: never;
}>;

export type CsaPageGetNodeObjectsQuery = {
  __typename?: 'Query';
  nodeObjects: Array<{
...
export class CsaPageGetNodeObjectsQueryService extends Apollo.Query<
  CsaPageGetNodeObjectsQuery,
  CsaPageGetNodeObjectsQueryVariables
> {
