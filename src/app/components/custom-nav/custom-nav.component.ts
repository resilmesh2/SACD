...
import {
  SentinelLayoutI18nService,
  SentinelNavI18n,
} from '@sentinel/layout/i18n';
...
@Component({
  ...
  imports: [MatTooltip, MatDivider, NgClass, AgendaContainerComponent],
  standalone: true,
})
export class CustomNavComponent {
  ...
  readonly agendaContainers: InputSignal<AgendaContainer[] | undefined> =
    input();
