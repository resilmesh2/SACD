...
var require_descent = __commonJS({
  "node_modules/webcola/dist/src/descent.js"(exports) {
    ...
    var Locks = function() {
      ...
      Locks2.prototype.add = function(id2, x) {
        this.locks[id2] = x;
      };
  ...
  "node_modules/webcola/dist/src/rectangle.js"(exports) {
    ...
    function generateGroupConstraints(root2, f, minSep, isContained) {
      ...
      if (isContained) {
        ...
        add(f.makeRect(open, close, min, padding), root2.minVar);
        root2.maxVar.desiredPosition = max;
        add(f.makeRect(open, close, max, padding), root2.maxVar);
      }
...
var require_gridrouter = __commonJS({
  "node_modules/webcola/dist/src/gridrouter.js"(exports) {
    ...
    var Vert = /* @__PURE__ */ function() {
      function Vert2(id2, x, y, node, line) {
        if (node === void 0) {
          node = null;
        }
        if (line === void 0) {
...
var GraphComponent = class {
   ...
   */
  panTo(x, y) {
    if (x === null || x === void 0 || isNaN(x) || y === null || y === void 0 || isNaN(y)) {
      return;
    }
  ...
  onMinimapPanTo(event2) {
    const x = event2.offsetX - (this.dims.width - (this.graphDims.width + this.minimapOffsetX) / this.minimapScaleCoefficient);
    const y = event2.offsetY + this.minimapOffsetY / this.minimapScaleCoefficient;
  ...
  panWithConstraints(key, event2) {
    let x = event2.movementX;
    let y = event2.movementY;
