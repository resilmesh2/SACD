...
var _HttpBatchLink = class _HttpBatchLink {
...
__publicField(_HttpBatchLink, "ɵfac", function HttpBatchLink_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _HttpBatchLink)(ɵɵinject(HttpClient));
});
__publicField(_HttpBatchLink, "ɵprov", ɵɵdefineInjectable({
  token: _HttpBatchLink,
  factory: _HttpBatchLink.ɵfac,
  providedIn: "root"
}));
var HttpBatchLink = _HttpBatchLink;
(() => {
...
__publicField(_HttpLink, "ɵfac", function HttpLink_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _HttpLink)(ɵɵinject(HttpClient));
});
__publicField(_HttpLink, "ɵprov", ɵɵdefineInjectable({
  token: _HttpLink,
  factory: _HttpLink.ɵfac,
  providedIn: "root"
}));
var HttpLink = _HttpLink;
(() => {
