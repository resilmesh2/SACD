...
var _NgxIndexedDBService = class _NgxIndexedDBService {
...
_NgxIndexedDBService.ɵfac = function NgxIndexedDBService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _NgxIndexedDBService)(ɵɵinject(CONFIG_TOKEN), ɵɵinject(PLATFORM_ID));
};
_NgxIndexedDBService.ɵprov = ɵɵdefineInjectable({
  token: _NgxIndexedDBService,
  factory: _NgxIndexedDBService.ɵfac
});
var NgxIndexedDBService = _NgxIndexedDBService;
(() => {
...
var _NgxIndexedDBModule = class _NgxIndexedDBModule {
...
_NgxIndexedDBModule.ɵfac = function NgxIndexedDBModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _NgxIndexedDBModule)();
};
_NgxIndexedDBModule.ɵmod = ɵɵdefineNgModule({
  type: _NgxIndexedDBModule,
  imports: [CommonModule]
});
_NgxIndexedDBModule.ɵinj = ɵɵdefineInjector({
  imports: [CommonModule]
});
var NgxIndexedDBModule = _NgxIndexedDBModule;
(() => {
