...
function ticker(year2, month2, week, day2, hour2, minute2) {
  ...
  function tickInterval(start2, stop, count2) {
    ...
    if (i === tickIntervals.length) return year2.every(tickStep(start2 / durationYear, stop / durationYear, count2));
    if (i === 0) return millisecond_default.every(Math.max(tickStep(start2, stop, count2), 1));
...
//# sourceMappingURL=chunk-CM2RBMR5.js.map
